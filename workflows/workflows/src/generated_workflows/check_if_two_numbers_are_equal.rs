...
pub fn workflow() -> Workflow {
    Workflow {
        name: r####"Check if two numbers are equal"####.into(),
        command: r####"[[ {{integer_a}} -eq {{integer_b}} ]]"####.into(),
        tags: vec![r####"shell"####.into()].into_iter().collect(),
        description: Some(
            r####"Returns an exit code of 0 if the two integers are equal to each other."####
                .into(),
        ),
        arguments: vec![
