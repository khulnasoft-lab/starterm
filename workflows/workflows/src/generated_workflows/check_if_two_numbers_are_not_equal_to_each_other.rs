...
pub fn workflow() -> Workflow {
    Workflow {
        name: r####"Check if two numbers are not equal to each other"####.into(),
        command: r####"[[ {{integer_a}} -ne {{integer_b}} ]]"####.into(),
        tags: vec![r####"shell"####.into()].into_iter().collect(),
        description: Some(
            r####"Returns an exit code of 0 if the two integers are not equal to each other."####
                .into(),
        ),
        arguments: vec![
