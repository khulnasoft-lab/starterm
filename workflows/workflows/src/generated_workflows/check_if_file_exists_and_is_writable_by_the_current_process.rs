...
pub fn workflow() -> Workflow {
    Workflow {
        name: r####"Check if file exists and is writable by the current process"####.into(),
        command: r####"[[ -w {{file}} ]]"####.into(),
        tags: vec![r####"shell"####.into()].into_iter().collect(),
        description: Some(
            r####"Returns an exit code of 0 if the file is writable by the current process."####
                .into(),
        ),
