...
pub fn workflow() -> Workflow {
    Workflow {
        name: r####"Reinstall all installed Homebrew formulae/casks"####.into(),
        command: r####"brew list -1 | xargs brew reinstall"####.into(),
        tags: vec![r####"homebrew"####.into()].into_iter().collect(),
        description: Some(r####"Reinstalls all installed Homebrew formulae and casks"####.into()),
