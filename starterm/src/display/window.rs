...
#[cfg(all(feature = "x11", not(any(target_os = "macos", windows))))]
const WINDOW_ICON: &[u8] = include_bytes!("../../extra/logo/compat/starterm-term.png");

/// This should match the definition of IDI_ICON from `starterm.rc`.
#[cfg(windows)]
...
///
/// Wraps the underlying windowing library to provide a stable API in Starterm.
pub struct Window {
