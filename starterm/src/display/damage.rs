...
use starterm_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `starterm_terminal` damage information into renderer damaged rects.
