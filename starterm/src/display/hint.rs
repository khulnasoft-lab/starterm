...
use starterm_terminal::grid::{BidirectionalIterator, Dimensions};
use starterm_terminal::index::{Boundary, Column, Direction, Line, Point};
use starterm_terminal::term::cell::Hyperlink;
use starterm_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use starterm_terminal::index::{Column, Line};
    use starterm_terminal::term::test::mock_term;
    use starterm_terminal::vte::ansi::Handler;
