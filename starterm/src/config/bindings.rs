...
use starterm_config_derive::{ConfigDeserialize, SerdeReplace};

use starterm_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the Starterm window.
    Hide,

    /// Hide all windows other than Starterm on macOS.
    HideOtherApplications,

    /// Minimize the Starterm window.
    Minimize,
    ...
    /// Spawn a new instance of Starterm.
    SpawnNewInstance,
