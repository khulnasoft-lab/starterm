...
use starterm_terminal::event::{Event, EventListener};
use starterm_terminal::grid::{Dimensions, Grid};
use starterm_terminal::index::{Column, Line};
use starterm_terminal::term::cell::Cell;
use starterm_terminal::term::test::TermSize;
use starterm_terminal::term::{Config, Term};
use starterm_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("starterm.recording"));
